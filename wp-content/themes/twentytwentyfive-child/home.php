<?php
/**
 * Home Template - Blog Posts Archive
 * Description: This template is used when a static page is set as the front page
 * and another page is set as the "Posts page" in Settings → Reading
 *
